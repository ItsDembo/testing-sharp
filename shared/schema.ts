...
export const users = pgTable("users", {
  ...
  trialStatus: text("trial_status").default("none"), // none, active, expired, used
  trialStartsAt: timestamp("trial_starts_at"),
  trialEndsAt: timestamp("trial_ends_at"),
  trialGrantedBy: text("trial_granted_by"), // admin user who granted the trial
  trialGrantedAt: timestamp("trial_granted_at"),
  // Access control
  isTestAccount: boolean("is_test_account").default(false), // for bypassing subscription checks during testing
