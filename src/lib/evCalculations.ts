...
// Re-export canonical EV calculations from shared library
export {
  calculateEV,
  calculateEVPercent,
  validateEVInputs,
  safeCalculateEV,
  type EVResult
} from '../../shared/lib/evCalculations.ts';

// Re-export canonical odds conversion functions
export {
  americanToDecimal,
  decimalToAmerican,
...
} from '../../shared/lib/oddsConversion.ts';
