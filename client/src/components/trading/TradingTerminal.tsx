...
import { EnhancedBetSlip, BetSlipData } from "@/components/terminal/EnhancedBetSlip";
...
export default function TradingTerminal() {
  ...
  const [minEV, setMinEV] = useState(-20); // Start with -20% to show negative EV opportunities
  const [searchQuery, setSearchQuery] = useState("");
  const [isPaused, setIsPaused] = useState(false);
  const [lastRefresh, setLastRefresh] = useState<Date>(new Date());

  // Enhanced Bet Slip state
  ...
  const filteredOpportunities = React.useMemo(() => {
    ...
    const filtered = opportunities.filter(opp => {
      ...
      if (activeTab === 'ev' && opp.ev <= -20) return false; // Show EV down to -20%
      if (activeTab === 'launch-status') return false; // Launch status tab shows no opportunities
  ...
  const counts = React.useMemo(() => {
    ...
    const ev = opportunities.filter(opp => opp.ev > -20).length; // Count EV down to -20%
  ...
  // Handle opening bet slip with bet data
  const openBetSlip = (opportunity: BettingOpportunity, sportsbook: string, odds: number) => {
    ...
    <div className="min-h-screen bg-black text-white font-mono">
      ...
      <div className="flex items-center justify-center py-4 bg-black px-4">
        <div className="flex gap-2 flex-wrap justify-center">
          {[
            { key: 'launch-status', label: '🚀 Launch Status', count: '', color: 'border-purple-400 bg-purple-400/20' },
        ...
        <div className="px-4 py-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-white mb-4">🚀 SharpShot Launch Status</h2>
              <p className="text-gray-400 text-lg">Real-time betting opportunities platform</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-gray-900 border border-gray-700 rounded-lg p-6">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-white">Sportsbook Coverage</h3>
                </div>
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    <span className="text-gray-400">Books Monitored:</span>
                    <span className="text-green-400">{statsData?.booksScanned || 18}</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    <span className="text-gray-400">Sports Covered:</span>
              ...
              <div className="bg-gray-900 border border-gray-700 rounded-lg p-6">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="text-green-400">{counts.all}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-400">+EV Opportunities:</span>
                    <span className="text-yellow-400">{counts.ev}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-400">Live Games:</span>
                    <span className="text-red-400">{counts.live}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 bg-gray-900 border border-gray-700 rounded-lg p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex items-center justify-between p-3 bg-gray-800 rounded">
                  <span className="text-gray-300">EV Calculation Engine</span>
                  <span className="text-green-400">✅ Active</span>
                </div>
                <div className="flex items-center justify-between p-3 bg-gray-800 rounded">
                  <span className="text-gray-300">Enhanced Bet Slip</span>
                  <span className="text-green-400">✅ Active</span>
                </div>
                <div className="flex items-center justify-between p-3 bg-gray-800 rounded">
                  <span className="text-gray-300">Kelly Criterion Calculator</span>
                  <span className="text-green-400">✅ Active</span>
                </div>
                <div className="flex items-center justify-between p-3 bg-gray-800 rounded">
                  <span className="text-gray-300">Multi-Sport Coverage</span>
                  <span className="text-green-400">✅ Active</span>
                </div>
                <div className="flex items-center justify-between p-3 bg-gray-800 rounded">
                          ...
                          return (
                            <div className="fo-slot" key={book}>
                              <div className="fo-stack">
                                ...
                                <button
                                  onClick={() => {
                                    // Open bet slip with this bet data
                                    openBetSlip(opp, bookOdds.sportsbook, bookOdds.odds);
                                  }}
                                  ...
                                  title={`Open bet slip for ${bookOdds.sportsbook} - ${formatOdds(bookOdds.odds)}`}
                                >
                  ...
                  <div className="flex flex-wrap gap-2">
                    {filterValidFieldOdds(
                      ...
                      <button
                        ...
                        onClick={() => {
                          // Open bet slip with this bet data
                          openBetSlip(opp, book.sportsbook, book.odds);
                        }}
