    ...
    <div className="space-y-3">
      ...
      <div className="relative my-6">
        ...
        <div className="relative flex justify-center text-sm">
          <span className="px-4 bg-gray-50/80 dark:bg-gray-900/80 text-gray-500 dark:text-gray-400">or</span>
        </div>
      </div>
      ...
      <Button
        ...
        disabled={disabled}
        className="w-full h-12 text-base bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 transition-all duration-200"
      >
