...
export default function SSOButtons({ onGoogleSignIn, onDiscordSignIn, disabled = false }: SSOButtonsProps) {
  return (
    <div className="space-y-3">
      {/* Divider */}
      <div className="relative my-6">
        <div className="absolute inset-0 flex items-center">
          <div className="w-full border-t border-[#D8AC35]/30"></div>
        </div>
        <div className="relative flex justify-center text-sm">
          <span className="px-4 bg-gray-50/80 dark:bg-gray-900/80 text-[#D8AC35] font-semibold uppercase tracking-wider">OR</span>
        </div>
      </div>
      ...
      <Button
        ...
        disabled={disabled}
        className="w-full h-12 text-base bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 active:translate-y-0.5 transition-all duration-200 rounded-full"
      >
