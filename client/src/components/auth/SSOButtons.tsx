  ...
  return (
    <div className="space-y-3">
      ...
      <Button
        ...
        disabled={disabled}
        className="w-full h-12 text-base bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 transition-all duration-200 rounded-full"
      >
