  ...
  return (
    <Card className="w-full border-[#D8AC35]/20 dark:border-[#00ff41]/20">
      ...
      <CardContent className="space-y-4">
        ...
        {oddsAccuracy && typeof oddsAccuracy === 'object' && (
          <div className="p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
            ...
            <div className="grid grid-cols-2 gap-2 text-xs">
              <div>
                ...
                <span className={`font-mono ${(oddsAccuracy as any)?.dataFreshness?.freshnessPercentage > 95 ? 'text-green-600' : 'text-yellow-600'}`}>
                  {(oddsAccuracy as any)?.dataFreshness?.freshnessPercentage?.toFixed(1) || 0}%
                </span>
              </div>
              <div>
                <span className="text-gray-600 dark:text-gray-400">Accuracy: </span>
                <span className={`font-mono ${(oddsAccuracy as any)?.oddsAccuracy?.accuracyPercentage > 98 ? 'text-green-600' : 'text-yellow-600'}`}>
                  {(oddsAccuracy as any)?.oddsAccuracy?.accuracyPercentage?.toFixed(1) || 0}%
                </span>
              </div>
            </div>
          </div>
